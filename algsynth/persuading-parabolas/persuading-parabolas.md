...
\begin{align*}
    ...
    &= (x-5)^2
\end{align*}
Suppose we have a parabola/quadratic that's a little different, like:
$$g(x) = x^2 - 10x + 23$$
...
\begin{align*}
    ...
    &= (x-5)^2-2
\end{align*}
BUT WAIT!!! Now it looks like something that's in transformed-parent-function form (aka vertex form)!!!! It looks like we just took $x^2$, moved it right by $5$, and down by $2$!!!! 
\begin{align*}
    &= (x-5)^2-2 \\ \\
    &= \big( \,\, x^2,\, \text{ moved right by $5$ and down by $2$} \,\, \big)
\end{align*}
AND THAT MEANS WE KNOW WHERE THE VERTEX/MINIMUM IS!!!! For unadorned bare parent function $x^2$, the vertex/minimum is at the origin $(0,0)$, so if we move it right by $5$ and down by $2$, now the vertex/minimumn is at $(+5,-2)$!!!
...
$$f(x) = x^2-6x+8$$
It's pretty! We want to look at it! To look at it, we'll need to factor it, so that we can find its roots and draw it. What are the roots?
$$f(x) = (x+\quad)(x+\quad)$$
...
$$(x-2)(x-4)$$
So then, we have roots/$x$-intercepts/solutions/zeroes at $x=+2$ and $x=+4$. Let's draw a picture! (Also, note that we have a $y$-intercept at $+8$):
...
\begin{align*}
\left(x - 3 \right)^2 \,\,&+8 \\
\left(x^2 - 6x + 9\right) \,\,&+8\quad \\
x^2 - 6x \,\, &+ 17
\end{align*}
Which is *totally different than what we had in the first place!*
\begin{align*}
\overbrace{\left(x - 3 \right)^2+8}^{\text{forced into vertex form}} \quad &\neq \quad \overbrace{\left(x^2 - 6x \right) +8}^{\text{the original equation}} \\ \\
\left(x^2 - 6x + 9\right) + 8\quad &\neq \quad \left(x^2 - 6x \right) +8 \\ \\
x^2 - 6x + 17 \quad&\neq\quad x^2-6x+8
\end{align*}
...
![](completing-the-square-example-3-3.svg){ width=50% }
...
Persuade each of the parabolas below into vertex form! In particular:
...
You can look up formulas online for how to complete the square (or perhaps you know them from previous math classes), but *don't* do this. Try to do it in the same way as in these notes---by getting up close and personal with the parabola. I really do want you to write out every step---to not just memorize the formula or algorithm for how to complete the square and mindlessly apply it––I want us to FEEL how these polynomials work and behave and exist!!! It's not about the answer!!!

<div style="column-width: 14em;  column-gap: 2em;  column-rule: 1px solid #ccc;">
<ol class='problems'>
<li> $x^{2} - 6x + 9$ <!-- =  (x - 3)^2  =  (x - 3)^2  --> </li>
<li> $x^{2} + 16x + 64$ <!-- =  (x + 8)^2  =  (x + 8)^2  --> </li>
<li> $-x^{2} + 24x - 144$ <!-- =  -(x - 12)^2  =  -(x - 12)^2  --> </li>
<li> $x^{2} - 6x + 7$ <!-- =  (x - 3)^2 - 2  =  (x + sqrt(2) - 3)*(x - sqrt(2) - 3)  --> </li>
<li> $x^{2} + 12x + 24$ <!-- =  (x + 6)^2 - 12  =  (x + 2*sqrt(3) + 6)*(x - 2*sqrt(3) + 6)  --> </li>
<li> $x^{2} - 2x - 4$ <!-- =  (x - 1)^2 - 5  =  (x + sqrt(5) - 1)*(x - sqrt(5) - 1)  --> </li>
<li> $x^{2} - 14x + 47$ <!-- =  (x - 7)^2 - 2  =  (x + sqrt(2) - 7)*(x - sqrt(2) - 7)  --> </li>
<li> $-x^{2} + 6x - 8$ <!-- =  -(x - 3)^2 + 1  =  -(x - 2)*(x - 4)  --> </li>
<li> $x^{2} - 2x - 35$ <!-- =  (x - 1)^2 - 36  =  (x + 5)*(x - 7)  --> </li>
<li> $x^{2} + 2x - 24$ <!-- =  (x + 1)^2 - 25  =  (x + 6)*(x - 4)  --> </li>
<li> $x^{2} + 5x + 3$ <!-- =  1/4*(2*x + 5)^2 - 13/4  =  1/4*(2*x + sqrt(13) + 5)*(2*x - sqrt(13) + 5)  --> </li>
<li> $2 x^{2} + 4x + 8$ <!-- =  2*(x + 1)^2 + 6  =  2*(x + sqrt(-3) + 1)*(x - sqrt(-3) + 1)  --> </li>
<li> $-5 x^{2} - 10x - 15$ <!-- =  -5*(x + 1)^2 - 10  =  -5*(x + sqrt(-2) + 1)*(x - sqrt(-2) + 1)  --> </li>
<li> $3 x^{2} + 27x + 9$ <!-- =  3/4*(2*x + 9)^2 - 207/4  =  3/4*(2*x + sqrt(69) + 9)*(2*x - sqrt(69) + 9)  --> </li>
<li> $-7 x^{2} + 16x - 100$ <!-- =  -1/7*(7*x - 8)^2 - 636/7  =  -1/7*(7*x + 2*sqrt(-159) - 8)*(7*x - 2*sqrt(-159) - 8)  --> </li>
<li> $10 x^{2} + 4x - 68$ <!-- =  2/5*(5*x + 1)^2 - 342/5  =  2/5*(5*x + 3*sqrt(19) + 1)*(5*x - 3*sqrt(19) + 1)  --> </li>
<li> $5 x^{2} - 7x + 2$ <!-- =  1/20*(10*x - 7)^2 - 9/20  =  (5*x - 2)*(x - 1)  --> </li>
<li> $7 x^{2} + 5x - 9$ <!-- =  1/28*(14*x + 5)^2 - 277/28  =  1/28*(14*x + sqrt(277) + 5)*(14*x - sqrt(277) + 5)  --> </li>
<li> $5 x^{2} - 3x - 11$ <!-- =  1/20*(10*x - 3)^2 - 229/20  =  1/20*(10*x + sqrt(229) - 3)*(10*x - sqrt(229) - 3)  --> </li>
<li> $5 x^{2} - 7x + 13$ <!-- =  1/20*(10*x - 7)^2 + 211/20  =  1/20*(10*x + sqrt(-211) - 7)*(10*x - sqrt(-211) - 7)  --> </li>
<li> $5 x^{2} - 7x + 2$ <!-- =  1/20*(10*x - 7)^2 - 9/20  =  (5*x - 2)*(x - 1)  --> </li>
<li> $7 x^{2} + 5x - 9$ <!-- =  1/28*(14*x + 5)^2 - 277/28  =  1/28*(14*x + sqrt(277) + 5)*(14*x - sqrt(277) + 5)  --> </li>
<li> $5 x^{2} - 3x - 11$ <!-- =  1/20*(10*x - 3)^2 - 229/20  =  1/20*(10*x + sqrt(229) - 3)*(10*x - sqrt(229) - 3)  --> </li>
<li> $5 x^{2} - 7x + 13$ <!-- =  1/20*(10*x - 7)^2 + 211/20  =  1/20*(10*x + sqrt(-211) - 7)*(10*x - sqrt(-211) - 7)  --> </li>
